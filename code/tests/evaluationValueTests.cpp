...
(
    std::vector<evaluationValue>
    ({
        evaluationValue(player::x, 0),
        evaluationValue(player::o, 0)
    }),
    std::vector<evaluationValue>
    ({
        evaluationValue(player::x, 81), 
        evaluationValue(player::draw, 81)
    }),
    std::vector<evaluationValue>
    ({
        evaluationValue(player::draw, 0),
        evaluationValue(player::o, 0)
    }),
    std::vector<evaluationValue>
    ({
...
(
    std::vector<evaluationValue>
    ({
        evaluationValue(player::neither, 0), 
        evaluationValue(player::x, 0)
    }),
    std::vector<evaluationValue>
    ({
    ...
    std::vector<evaluationValue>
    ({
        evaluationValue(player::x, 82), 
        evaluationValue(player::x, 0)
    }),
    std::vector<evaluationValue>
    ({
        evaluationValue(player::x, -1), 
        evaluationValue(player::x, 0)
    }),
    std::vector<evaluationValue>
    ({
